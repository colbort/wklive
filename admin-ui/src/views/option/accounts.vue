  ...
  <div class="module-page">
    ...
    <el-card shadow="never" class="table-card">
      <el-table v-loading="loading" :data="rows" stripe>
        ...
        <el-table-column :label="t('option.balance')" prop="balance" min-width="120" show-overflow-tooltip />
        <el-table-column :label="t('option.availableBalance')" prop="availableBalance" min-width="120" show-overflow-tooltip />
...
const showDetail = async (row: Record<string, any>) => {
  detailData.value = (await optionService.getAccount({ tenantId: row.tenantId, id: row.id, accountId: row.accountId })).data || row
