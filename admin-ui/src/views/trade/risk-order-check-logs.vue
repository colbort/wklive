  ...
  <div class="module-page">
    ...
    <el-card shadow="never" class="query-card">
      ...
      >
        ...
        </el-form-item><el-form-item :label="t('trade.orderNo')">
      ...
      </el-form><el-table v-loading="loading" :data="rows" stripe>
        <el-table-column
          prop="orderNo"
          :label="t('trade.orderNo')"
          min-width="180"
          show-overflow-tooltip
        /><el-table-column prop="userId" :label="t('trade.userId')" width="100" /><el-table-column
          prop="symbolId"
          :label="t('trade.symbolId')"
          width="100"
        /><el-table-column prop="checkType" :label="t('trade.checkType')" width="100" /><el-table-column
          prop="checkResult"
        ...
        /><el-table-column :label="t('common.actions')" width="100" fixed="right">
          <template #default="{ row }">
            <el-button
              link
              type="primary"
              @click="detailData = row, detailVisible = true"
            >
              {{ t('option.detail') }}
            </el-button>
          </template>
    ...
    </el-card><el-dialog v-model="detailVisible" :title="t('option.detail')" width="760px">
...
const riskQuery = reactive<Record<string, any>>({
  tenantId: 0,
  userId: 0,
  symbolId: 0,
  marketType: 0,
})
const riskLogQuery = reactive<Record<string, any>>({
  tenantId: 0,
  userId: 0,
  symbolId: 0,
  orderNo: '',
