...
import {
  ...
  apiOptionCreateInsuranceInventoryExit,
  apiOptionReviewInsuranceInventoryExit,
  apiOptionExecuteInsuranceInventoryExit,
  apiOptionListInsuranceInventoryExits,
...
export type UpdateContractReq = Omit<
  OptionContract,
...
export type OptionInsuranceInventoryExit = {
  id: number;
  tenantId: number;
  requestNo: string;
  positionId: number;
...
export type CreateInsuranceInventoryExitReq = {
  tenantId: number;
  positionId: number;
  quantity: string;
  limitPrice: string;
...
export type ReviewInsuranceInventoryExitReq = {
  tenantId: number;
  exitId: number;
  approve: boolean;
  reason: string;
...
export type ExecuteInsuranceInventoryExitReq = {
  tenantId: number;
  exitId: number;
};

export type ListInsuranceInventoryExitsReq = {
  cursor?: number;
  limit?: number;
  tenantId: number;
  positionId?: number;
...
> &
  Partial<
    Pick<
      OptionMarket,
      "underlyingSnapshotTime" | "markSnapshotTime" | "greeksSnapshotTime"
    >
  >;
...
export class OptionService {
  ...
  createInsuranceInventoryExit(params: CreateInsuranceInventoryExitReq) {
    return apiOptionCreateInsuranceInventoryExit(params);
  }

  reviewInsuranceInventoryExit(params: ReviewInsuranceInventoryExitReq) {
    return apiOptionReviewInsuranceInventoryExit(params);
  }

  executeInsuranceInventoryExit(params: ExecuteInsuranceInventoryExitReq) {
    return apiOptionExecuteInsuranceInventoryExit(params);
  }

  listInsuranceInventoryExits(params: ListInsuranceInventoryExitsReq) {
    return apiOptionListInsuranceInventoryExits(params);
  }
