export default {
  ...
  common: {
    ...
    qrCode: 'QR Code',
    click2faBindGenerateQrCode: 'Click “2FA Bind” to generate QR code',    scanQrCodeWithGoogleAuthenticator: 'Please scan the QR code with Google Authenticator',    goHome: 'Back to Home',
    user: 'User',
