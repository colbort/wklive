...
(1019, 1010, '设置秒合约配置', 3, 'POST', '/trade/symbols/seconds-config', 'trade:symbol:seconds-config', '', '', 1019),
(1022, 1010, '设置交易时段', 3, 'POST', '/trade/symbols/session', 'trade:symbol:session:update', '', '', 1022),
...
(1102, 1100, '获取用户合约配置', 3, 'GET', '/trade/contract-user-config', 'trade:contract-user-config:detail', '', '', 1102),
(1103, 1100, '设置用户合约配置', 3, 'POST', '/trade/contract-user-config', 'trade:contract-user-config:update', '', '', 1103),
