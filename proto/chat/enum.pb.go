...
const (
	...
	// 网络异常
	ChatSessionStatus_CHAT_SESSION_STATUS_INTERNET_ERROR ChatSessionStatus = 7
)
...
var (
	ChatSessionStatus_name = map[int32]string{
		...
		7: "CHAT_SESSION_STATUS_INTERNET_ERROR",
	}
...
const (
	...
	// 网络异常
	ChatSessionCloseReason_CHAT_SESSION_CLOSE_REASON_INTERNET_ERROR ChatSessionCloseReason = 7
)
...
var (
	ChatSessionCloseReason_name = map[int32]string{
		...
		7: "CHAT_SESSION_CLOSE_REASON_INTERNET_ERROR",
	}
...
const (
	...
	// ws 连接确认
	// 例如：客户端连接成功后，推送确认信息
	ChatEventType_CHAT_EVENT_TYPE_WS_CONNECTED ChatEventType = 1
	// 普通聊天消息
	ChatEventType_CHAT_EVENT_TYPE_MESSAGE ChatEventType = 2
	// 通用系统通知
	// 例如：系统维护、风险提示、暂无客服在线、普通提示
	ChatEventType_CHAT_EVENT_TYPE_SYSTEM_NOTICE ChatEventType = 3
	// 用户进入客服页面 / 建立 WebSocket 连接
	ChatEventType_CHAT_EVENT_TYPE_USER_JOIN ChatEventType = 4
	// 用户离开客服页面 / 断开 WebSocket 连接
	ChatEventType_CHAT_EVENT_TYPE_USER_LEAVE ChatEventType = 5
	// 等待服务列表信息更新
	// 例如：进入等待列表、取消等待、等待人数变化、预计等待时间变化
	ChatEventType_CHAT_EVENT_TYPE_QUEUE_UPDATE ChatEventType = 6
	// 坐席主动接待会话
	// 例如：坐席 小王 已接待本次会话
	ChatEventType_CHAT_EVENT_TYPE_AGENT_ACCEPTED ChatEventType = 7
	// 坐席离开会话
	ChatEventType_CHAT_EVENT_TYPE_AGENT_LEAVE ChatEventType = 8
	// 会话转接发起
	// 例如：坐席 小王 发起转接给坐席 小李
	ChatEventType_CHAT_EVENT_TYPE_TRANSFER_REQUEST ChatEventType = 9
	// 会话转接接受
	// 例如：坐席 小李 接受转接
	ChatEventType_CHAT_EVENT_TYPE_TRANSFER_ACCEPT ChatEventType = 10
	// 会话转接拒绝
	// 例如：坐席 小李 拒绝转接
	ChatEventType_CHAT_EVENT_TYPE_TRANSFER_REJECT ChatEventType = 11
	// 会话关闭 / 会话结束
	// 具体关闭原因用 ChatSessionCloseReason 表示
	ChatEventType_CHAT_EVENT_TYPE_SESSION_CLOSE ChatEventType = 12
	// 邀请用户评价
	ChatEventType_CHAT_EVENT_TYPE_EVALUATION_INVITE ChatEventType = 13
	// 用户提交评价
	ChatEventType_CHAT_EVENT_TYPE_EVALUATION_SUBMIT ChatEventType = 14
	// 正在输入
	// 建议发送方每隔 1~2 秒节流发送一次
	// 接收方 3~5 秒内没有继续收到 TYPING，则自动隐藏“正在输入”
	ChatEventType_CHAT_EVENT_TYPE_TYPING ChatEventType = 15
	// 消息已送达
	ChatEventType_CHAT_EVENT_TYPE_MESSAGE_DELIVERED ChatEventType = 16
	// 消息已读
	ChatEventType_CHAT_EVENT_TYPE_MESSAGE_READ ChatEventType = 17
	// 消息撤回
	ChatEventType_CHAT_EVENT_TYPE_MESSAGE_RECALL ChatEventType = 18
	// 消息删除
	ChatEventType_CHAT_EVENT_TYPE_MESSAGE_DELETE ChatEventType = 19
	// 心跳
	ChatEventType_CHAT_EVENT_TYPE_HEARTBEAT ChatEventType = 20
	// 错误事件
	// 例如：发送失败、会话不存在、权限不足
	ChatEventType_CHAT_EVENT_TYPE_ERROR ChatEventType = 21
)
...
var (
	ChatEventType_name = map[int32]string{
		...
		1:  "CHAT_EVENT_TYPE_WS_CONNECTED",
		2:  "CHAT_EVENT_TYPE_MESSAGE",
		3:  "CHAT_EVENT_TYPE_SYSTEM_NOTICE",
		4:  "CHAT_EVENT_TYPE_USER_JOIN",
		5:  "CHAT_EVENT_TYPE_USER_LEAVE",
		6:  "CHAT_EVENT_TYPE_QUEUE_UPDATE",
		7:  "CHAT_EVENT_TYPE_AGENT_ACCEPTED",
		8:  "CHAT_EVENT_TYPE_AGENT_LEAVE",
		9:  "CHAT_EVENT_TYPE_TRANSFER_REQUEST",
		10: "CHAT_EVENT_TYPE_TRANSFER_ACCEPT",
		11: "CHAT_EVENT_TYPE_TRANSFER_REJECT",
		12: "CHAT_EVENT_TYPE_SESSION_CLOSE",
		13: "CHAT_EVENT_TYPE_EVALUATION_INVITE",
		14: "CHAT_EVENT_TYPE_EVALUATION_SUBMIT",
		15: "CHAT_EVENT_TYPE_TYPING",
		16: "CHAT_EVENT_TYPE_MESSAGE_DELIVERED",
		17: "CHAT_EVENT_TYPE_MESSAGE_READ",
		18: "CHAT_EVENT_TYPE_MESSAGE_RECALL",
		19: "CHAT_EVENT_TYPE_MESSAGE_DELETE",
		20: "CHAT_EVENT_TYPE_HEARTBEAT",
		21: "CHAT_EVENT_TYPE_ERROR",
	}
...
const file_proto_chat_enum_proto_rawDesc = "" +
	...
	"\x1aCHAT_SESSION_SOURCE_SYSTEM\x10\x04*\xb1\x02\n" +
	...
	" CHAT_SESSION_STATUS_TRANSFERRING\x10\x06\x12&\n" +
	"\"CHAT_SESSION_STATUS_INTERNET_ERROR\x10\a*\xbb\x01\n" +
	...
	"\x1cCHAT_SESSION_PRIORITY_URGENT\x10\x04*\xda\x02\n" +
	...
	")CHAT_SESSION_CLOSE_REASON_TRANSFER_FAILED\x10\x06\x12,\n" +
	"(CHAT_SESSION_CLOSE_REASON_INTERNET_ERROR\x10\a*\xc4\x01\n" +
	...
	"\x19CHAT_ASSIGN_TYPE_TRANSFER\x10\x03*\x80\x06\n" +
	"\rChatEventType\x12\x1f\n" +
	"\x1bCHAT_EVENT_TYPE_UNSPECIFIED\x10\x00\x12 \n" +
	"\x1cCHAT_EVENT_TYPE_WS_CONNECTED\x10\x01\x12\x1b\n" +
	"\x17CHAT_EVENT_TYPE_MESSAGE\x10\x02\x12!\n" +
	"\x1dCHAT_EVENT_TYPE_SYSTEM_NOTICE\x10\x03\x12\x1d\n" +
	"\x19CHAT_EVENT_TYPE_USER_JOIN\x10\x04\x12\x1e\n" +
	"\x1aCHAT_EVENT_TYPE_USER_LEAVE\x10\x05\x12 \n" +
	"\x1cCHAT_EVENT_TYPE_QUEUE_UPDATE\x10\x06\x12\"\n" +
	"\x1eCHAT_EVENT_TYPE_AGENT_ACCEPTED\x10\a\x12\x1f\n" +
	"\x1bCHAT_EVENT_TYPE_AGENT_LEAVE\x10\b\x12$\n" +
	" CHAT_EVENT_TYPE_TRANSFER_REQUEST\x10\t\x12#\n" +
	"\x1fCHAT_EVENT_TYPE_TRANSFER_ACCEPT\x10\n" +
	"\x12#\n" +
	"\x1fCHAT_EVENT_TYPE_TRANSFER_REJECT\x10\v\x12!\n" +
	"\x1dCHAT_EVENT_TYPE_SESSION_CLOSE\x10\f\x12%\n" +
	"!CHAT_EVENT_TYPE_EVALUATION_INVITE\x10\r\x12%\n" +
	"!CHAT_EVENT_TYPE_EVALUATION_SUBMIT\x10\x0e\x12\x1a\n" +
	"\x16CHAT_EVENT_TYPE_TYPING\x10\x0f\x12%\n" +
	"!CHAT_EVENT_TYPE_MESSAGE_DELIVERED\x10\x10\x12 \n" +
	"\x1cCHAT_EVENT_TYPE_MESSAGE_READ\x10\x11\x12\"\n" +
	"\x1eCHAT_EVENT_TYPE_MESSAGE_RECALL\x10\x12\x12\"\n" +
	"\x1eCHAT_EVENT_TYPE_MESSAGE_DELETE\x10\x13\x12\x1d\n" +
	"\x19CHAT_EVENT_TYPE_HEARTBEAT\x10\x14\x12\x19\n" +
	"\x15CHAT_EVENT_TYPE_ERROR\x10\x15*\xdb\x02\n" +
