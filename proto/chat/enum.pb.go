...
const (
	...
	// 坐席上线；给商户后台使用，刷新坐席状态
	ChatEventType_CHAT_EVENT_TYPE_AGENT_JOIN ChatEventType = 7
	// 坐席主动接待会话
	// 例如：坐席 小王 已接待本次会话
	ChatEventType_CHAT_EVENT_TYPE_AGENT_ACCEPTED ChatEventType = 8
	// 坐席离开会话
	ChatEventType_CHAT_EVENT_TYPE_AGENT_LEAVE ChatEventType = 9
	// 会话转接发起
	// 例如：坐席 小王 发起转接给坐席 小李
	ChatEventType_CHAT_EVENT_TYPE_TRANSFER_REQUEST ChatEventType = 10
	// 会话转接接受
	// 例如：坐席 小李 接受转接
	ChatEventType_CHAT_EVENT_TYPE_TRANSFER_ACCEPT ChatEventType = 11
	// 会话转接拒绝
	// 例如：坐席 小李 拒绝转接
	ChatEventType_CHAT_EVENT_TYPE_TRANSFER_REJECT ChatEventType = 12
	// 会话关闭 / 会话结束
	...
	// 消息已送达
	ChatEventType_CHAT_EVENT_TYPE_MESSAGE_DELIVERED ChatEventType = 17
	// 消息已读
	ChatEventType_CHAT_EVENT_TYPE_MESSAGE_READ ChatEventType = 18
	// 消息撤回
	ChatEventType_CHAT_EVENT_TYPE_MESSAGE_RECALL ChatEventType = 19
	// 消息删除
	ChatEventType_CHAT_EVENT_TYPE_MESSAGE_DELETE ChatEventType = 20
	// 心跳
...
var (
	ChatEventType_name = map[int32]string{
		...
		7:  "CHAT_EVENT_TYPE_AGENT_JOIN",
		8:  "CHAT_EVENT_TYPE_AGENT_ACCEPTED",
		9:  "CHAT_EVENT_TYPE_AGENT_LEAVE",
		10: "CHAT_EVENT_TYPE_TRANSFER_REQUEST",
		11: "CHAT_EVENT_TYPE_TRANSFER_ACCEPT",
		12: "CHAT_EVENT_TYPE_TRANSFER_REJECT",
		...
		17: "CHAT_EVENT_TYPE_MESSAGE_DELIVERED",
		18: "CHAT_EVENT_TYPE_MESSAGE_READ",
		19: "CHAT_EVENT_TYPE_MESSAGE_RECALL",
		20: "CHAT_EVENT_TYPE_MESSAGE_DELETE",
	...
	ChatEventType_value = map[string]int32{
		...
		"CHAT_EVENT_TYPE_AGENT_JOIN":        7,
		"CHAT_EVENT_TYPE_AGENT_ACCEPTED":    8,
		"CHAT_EVENT_TYPE_AGENT_LEAVE":       9,
		"CHAT_EVENT_TYPE_TRANSFER_REQUEST":  10,
		"CHAT_EVENT_TYPE_TRANSFER_ACCEPT":   11,
		"CHAT_EVENT_TYPE_TRANSFER_REJECT":   12,
		...
		"CHAT_EVENT_TYPE_MESSAGE_DELIVERED": 17,
		"CHAT_EVENT_TYPE_MESSAGE_READ":      18,
		"CHAT_EVENT_TYPE_MESSAGE_RECALL":    19,
		"CHAT_EVENT_TYPE_MESSAGE_DELETE":    20,
...
const file_proto_chat_enum_proto_rawDesc = "" +
	...
	"\x19CHAT_ASSIGN_TYPE_TRANSFER\x10\x03*\xa0\x06\n" +
	...
	"\x1cCHAT_EVENT_TYPE_QUEUE_UPDATE\x10\x06\x12\x1e\n" +
	"\x1aCHAT_EVENT_TYPE_AGENT_JOIN\x10\a\x12\"\n" +
	"\x1eCHAT_EVENT_TYPE_AGENT_ACCEPTED\x10\b\x12\x1f\n" +
	"\x1bCHAT_EVENT_TYPE_AGENT_LEAVE\x10\t\x12$\n" +
	" CHAT_EVENT_TYPE_TRANSFER_REQUEST\x10\n" +
	"\x12#\n" +
	"\x1fCHAT_EVENT_TYPE_TRANSFER_ACCEPT\x10\v\x12#\n" +
	"\x1fCHAT_EVENT_TYPE_TRANSFER_REJECT\x10\f\x12!\n" +
	...
	"\x16CHAT_EVENT_TYPE_TYPING\x10\x10\x12%\n" +
	"!CHAT_EVENT_TYPE_MESSAGE_DELIVERED\x10\x11\x12 \n" +
	"\x1cCHAT_EVENT_TYPE_MESSAGE_READ\x10\x12\x12\"\n" +
	"\x1eCHAT_EVENT_TYPE_MESSAGE_RECALL\x10\x13\x12\"\n" +
	"\x1eCHAT_EVENT_TYPE_MESSAGE_DELETE\x10\x14\x12\x1d\n" +
	"\x19CHAT_EVENT_TYPE_HEARTBEAT\x10\x15\x12\x19\n" +
	"\x15CHAT_EVENT_TYPE_ERROR\x10\x16*\xdb\x02\n" +
