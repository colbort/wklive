...
// 	protoc        v5.29.3
// source: proto/market/enum.proto
...
func (CategoryType) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_market_enum_proto_enumTypes[0].Descriptor()
}

func (CategoryType) Type() protoreflect.EnumType {
	return &file_proto_market_enum_proto_enumTypes[0]
}
...
func (CategoryType) EnumDescriptor() ([]byte, []int) {
	return file_proto_market_enum_proto_rawDescGZIP(), []int{0}
}
...
func (KlineType) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_market_enum_proto_enumTypes[1].Descriptor()
}

func (KlineType) Type() protoreflect.EnumType {
	return &file_proto_market_enum_proto_enumTypes[1]
}
...
func (KlineType) EnumDescriptor() ([]byte, []int) {
	return file_proto_market_enum_proto_rawDescGZIP(), []int{1}
}
...
func (SyncKlinePriority) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_market_enum_proto_enumTypes[2].Descriptor()
}

func (SyncKlinePriority) Type() protoreflect.EnumType {
	return &file_proto_market_enum_proto_enumTypes[2]
}
...
func (SyncKlinePriority) EnumDescriptor() ([]byte, []int) {
	return file_proto_market_enum_proto_rawDescGZIP(), []int{2}
}
...
func (PriceAlgorithm) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_market_enum_proto_enumTypes[3].Descriptor()
}

func (PriceAlgorithm) Type() protoreflect.EnumType {
	return &file_proto_market_enum_proto_enumTypes[3]
}
...
func (PriceAlgorithm) EnumDescriptor() ([]byte, []int) {
	return file_proto_market_enum_proto_rawDescGZIP(), []int{3}
}

var File_proto_market_enum_proto protoreflect.FileDescriptor

const file_proto_market_enum_proto_rawDesc = "" +
	"\n" +
	"\x17proto/market/enum.proto\x12\x06market*\xc2\x01\n" +
	...
	"\x1bPRICE_ALGORITHM_INDEX_BASIS\x10\x04B\x1cZ\x1awklive/proto/market;marketb\x06proto3"

var (
	file_proto_market_enum_proto_rawDescOnce sync.Once
	file_proto_market_enum_proto_rawDescData []byte
)

func file_proto_market_enum_proto_rawDescGZIP() []byte {
	file_proto_market_enum_proto_rawDescOnce.Do(func() {
		file_proto_market_enum_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_market_enum_proto_rawDesc), len(file_proto_market_enum_proto_rawDesc)))
	})
	return file_proto_market_enum_proto_rawDescData
}

var file_proto_market_enum_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
var file_proto_market_enum_proto_goTypes = []any{
	(CategoryType)(0),      // 0: market.CategoryType
	(KlineType)(0),         // 1: market.KlineType
	(SyncKlinePriority)(0), // 2: market.SyncKlinePriority
	(PriceAlgorithm)(0),    // 3: market.PriceAlgorithm
}
var file_proto_market_enum_proto_depIdxs = []int32{
...
func init() { file_proto_market_enum_proto_init() }
func file_proto_market_enum_proto_init() {
	if File_proto_market_enum_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_market_enum_proto_rawDesc), len(file_proto_market_enum_proto_rawDesc)),
			NumEnums:      4,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_proto_market_enum_proto_goTypes,
		DependencyIndexes: file_proto_market_enum_proto_depIdxs,
		EnumInfos:         file_proto_market_enum_proto_enumTypes,
	}.Build()
	File_proto_market_enum_proto = out.File
	file_proto_market_enum_proto_goTypes = nil
	file_proto_market_enum_proto_depIdxs = nil
}
