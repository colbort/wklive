...
func (UnimplementedUserAppServer) SubmitIdentity(context.Context, *SubmitIdentityReq) (*SubmitIdentityResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SubmitIdentity not implemented")
}
...
func (UnimplementedUserAppServer) ChangePayPassword(context.Context, *ChangePayPasswordReq) (*AppCommonResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ChangePayPassword not implemented")
}
func (UnimplementedUserAppServer) InitGoogle2FA(context.Context, *InitGoogle2FAReq) (*InitGoogle2FAResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method InitGoogle2FA not implemented")
}
func (UnimplementedUserAppServer) EnableGoogle2FA(context.Context, *EnableGoogle2FAReq) (*AppCommonResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method EnableGoogle2FA not implemented")
}
func (UnimplementedUserAppServer) DisableGoogle2FA(context.Context, *DisableGoogle2FAReq) (*AppCommonResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DisableGoogle2FA not implemented")
}
...
func (UnimplementedUserAppServer) SetDefaultBank(context.Context, *SetDefaultBankReq) (*AppCommonResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SetDefaultBank not implemented")
}
...
func RegisterUserAppServer(s grpc.ServiceRegistrar, srv UserAppServer) {
	// If the following call pancis, it indicates UnimplementedUserAppServer was
