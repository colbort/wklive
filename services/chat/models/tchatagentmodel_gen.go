...
func (m *defaultTChatAgentModel) Insert(ctx context.Context, data *TChatAgent) (sql.Result, error) {
	...
	ret, err := m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.ExecCtx(ctx, query, data.MerchantId, data.ChatUserId, data.GroupId, data.AgentNo, data.Status, data.MaxSessionCount, data.CurrentSessionCount, data.LastActiveTime, data.Remark, data.CreateTimes, data.UpdateTimes)
	}, tChatAgentIdKey, tChatAgentMerchantIdAgentNoKey, tChatAgentMerchantIdChatUserIdKey)
	return ret, err
}
...
func (m *defaultTChatAgentModel) Update(ctx context.Context, newData *TChatAgent) error {
	...
	_, err = m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.ExecCtx(ctx, query, newData.MerchantId, newData.ChatUserId, newData.GroupId, newData.AgentNo, newData.Status, newData.MaxSessionCount, newData.CurrentSessionCount, newData.LastActiveTime, newData.Remark, newData.CreateTimes, newData.UpdateTimes, newData.Id)
	}, tChatAgentIdKey, tChatAgentMerchantIdAgentNoKey, tChatAgentMerchantIdChatUserIdKey)
	return err
}
