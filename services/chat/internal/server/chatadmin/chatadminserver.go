...
import (
	...
	"wklive/proto/chat"
	"wklive/services/chat/internal/logic/chatadmin"
...
func (s *ChatAdminServer) Login(ctx context.Context, in *chat.ChatAdminLoginReq) (*chat.ChatAdminLoginResp, error) {
	l := chatadminlogic.NewLoginLogic(ctx, s.svcCtx)
	return l.Login(in)
}
...
func (s *ChatAdminServer) Profile(ctx context.Context, in *chat.ChatAdminProfileReq) (*chat.ChatAdminProfileResp, error) {
	l := chatadminlogic.NewProfileLogic(ctx, s.svcCtx)
	return l.Profile(in)
}
...
func (s *ChatAdminServer) UpdateProfile(ctx context.Context, in *chat.UpdateChatAdminProfileReq) (*chat.ChatAdminProfileResp, error) {
	l := chatadminlogic.NewUpdateProfileLogic(ctx, s.svcCtx)
...
func (s *ChatAdminServer) GetChatUserById(ctx context.Context, in *chat.GetChatUserByIdReq) (*chat.GetChatUserByIdResp, error) {
	l := chatadminlogic.NewGetChatUserByIdLogic(ctx, s.svcCtx)
...
func (s *ChatAdminServer) PageChatGroups(ctx context.Context, in *chat.PageChatGroupsReq) (*chat.PageChatGroupsResp, error) {
	l := chatadminlogic.NewPageChatGroupsLogic(ctx, s.svcCtx)
...
func (s *ChatAdminServer) PageChatAgents(ctx context.Context, in *chat.PageChatAgentsReq) (*chat.PageChatAgentsResp, error) {
	l := chatadminlogic.NewPageChatAgentsLogic(ctx, s.svcCtx)
...
func (s *ChatAdminServer) PageChatSessions(ctx context.Context, in *chat.PageChatSessionsReq) (*chat.PageChatSessionsResp, error) {
	l := chatadminlogic.NewPageChatSessionsLogic(ctx, s.svcCtx)
...
func (s *ChatAdminServer) AcceptChatSession(ctx context.Context, in *chat.AcceptChatSessionReq) (*chat.AcceptChatSessionResp, error) {
	l := chatadminlogic.NewAcceptChatSessionLogic(ctx, s.svcCtx)
...
func (s *ChatAdminServer) PageChatMessages(ctx context.Context, in *chat.PageChatMessagesReq) (*chat.PageChatMessagesResp, error) {
	l := chatadminlogic.NewPageChatMessagesLogic(ctx, s.svcCtx)
...
func (s *ChatAdminServer) PageChatQuickReplies(ctx context.Context, in *chat.PageChatQuickRepliesReq) (*chat.PageChatQuickRepliesResp, error) {
	l := chatadminlogic.NewPageChatQuickRepliesLogic(ctx, s.svcCtx)
...
func (s *ChatAdminServer) ListEnabledChatQuickReplies(ctx context.Context, in *chat.ListEnabledChatQuickRepliesReq) (*chat.ListChatQuickRepliesResp, error) {
	l := chatadminlogic.NewListEnabledChatQuickRepliesLogic(ctx, s.svcCtx)
...
func (s *ChatAdminServer) PageChatCategories(ctx context.Context, in *chat.PageChatCategoriesReq) (*chat.PageChatCategoriesResp, error) {
	l := chatadminlogic.NewPageChatCategoriesLogic(ctx, s.svcCtx)
...
func (s *ChatAdminServer) ListEnabledChatCategories(ctx context.Context, in *chat.ListEnabledChatCategoriesReq) (*chat.ListChatCategoriesResp, error) {
	l := chatadminlogic.NewListEnabledChatCategoriesLogic(ctx, s.svcCtx)
...
func (s *ChatAdminServer) PageChatWorkOrders(ctx context.Context, in *chat.PageChatWorkOrdersReq) (*chat.PageChatWorkOrdersResp, error) {
	l := chatadminlogic.NewPageChatWorkOrdersLogic(ctx, s.svcCtx)
