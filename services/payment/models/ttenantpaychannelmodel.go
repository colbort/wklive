...
func (m *customTTenantPayChannelModel) FindByIDs(ctx context.Context, ids []int64) ([]*TTenantPayChannel, error) {
	if len(ids) == 0 {
		return nil, nil
	}
...
func (m *customTTenantPayChannelModel) FindPage(ctx context.Context, filter TenantPayChannelPageFilter, cursor int64, limit int64) ([]*TTenantPayChannel, int64, error) {
