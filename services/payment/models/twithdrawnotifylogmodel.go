...
func (m *customTWithdrawNotifyLogModel) FindPage(ctx context.Context, filter WithdrawNotifyLogPageFilter, cursor int64, limit int64) ([]*TWithdrawNotifyLog, int64, error) {
