...
func (m *customTUserRechargeStatModel) FindPage(ctx context.Context, filter UserRechargeStatPageFilter, cursor int64, limit int64) ([]*TUserRechargeStat, int64, error) {
