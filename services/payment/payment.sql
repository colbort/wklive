...
CREATE TABLE `t_tenant_pay_channel` (
  ...
  `single_min_amount` decimal(36,18) NOT NULL DEFAULT 0 COMMENT '单笔最小金额，自然货币单位',
  `single_max_amount` decimal(36,18) NOT NULL DEFAULT 0 COMMENT '单笔最大金额，0表示不限制',
  `daily_max_amount` decimal(36,18) NOT NULL DEFAULT 0 COMMENT '单日最大金额，0表示不限制',
  ...
  `fee_fixed_amount` decimal(36,18) NOT NULL DEFAULT 0 COMMENT '固定手续费，自然货币单位',
...
CREATE TABLE `t_tenant_pay_channel_rule` (
  ...
  `single_amount_min` decimal(36,18) NOT NULL DEFAULT 0 COMMENT '单笔充值最小金额，自然货币单位',
  `single_amount_max` decimal(36,18) NOT NULL DEFAULT 0 COMMENT '单笔充值最大金额，0表示不限制',

  `user_total_recharge_min` decimal(36,18) NOT NULL DEFAULT 0 COMMENT '用户累计充值最小金额，自然货币单位',
  `user_total_recharge_max` decimal(36,18) NOT NULL DEFAULT 0 COMMENT '用户累计充值最大金额，0表示不限制',
...
CREATE TABLE `t_user_recharge_stat` (
  ...
  `success_total_amount` decimal(36,18) NOT NULL DEFAULT 0 COMMENT '成功累计充值金额，自然货币单位',
  `today_success_amount` decimal(36,18) NOT NULL DEFAULT 0 COMMENT '今日成功充值金额，自然货币单位',
...
CREATE TABLE `t_recharge_order` (
  ...
  `currency` varchar(16) NOT NULL DEFAULT 'CNY' COMMENT '币种',
  `order_amount` decimal(36,18) NOT NULL COMMENT '订单金额，自然货币单位',
  `pay_amount` decimal(36,18) NOT NULL DEFAULT 0 COMMENT '实际支付金额，自然货币单位',
  `fee_amount` decimal(36,18) NOT NULL DEFAULT 0 COMMENT '手续费金额，自然货币单位',
...
CREATE TABLE `t_withdraw_order` (
  ...
  `channel_id` bigint NOT NULL COMMENT '通道ID',
  `currency` varchar(16) NOT NULL DEFAULT 'CNY' COMMENT '币种',
  `amount` decimal(36,18) NOT NULL COMMENT '订单金额，自然货币单位',
  `fee_amount` decimal(36,18) NOT NULL DEFAULT 0 COMMENT '手续费金额，自然货币单位',
  `actual_amount` decimal(36,18) NOT NULL DEFAULT 0 COMMENT '实际到账金额，自然货币单位',
  `client_type` tinyint NOT NULL DEFAULT 1 COMMENT '客户端类型：1APP 2H5 3WEB',
  `client_ip` varchar(64) DEFAULT NULL COMMENT '客户端IP',
