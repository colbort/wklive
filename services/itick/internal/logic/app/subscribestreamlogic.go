...
func (l *SubscribeStreamLogic) SubscribeStream(in *itick.SubscribeRequest, stream itick.App_SubscribeStreamServer) error {
...
func (l *SubscribeStreamLogic) pushCachedMarketData(
	...
	stream itick.App_SubscribeStreamServer,
) error {
