...
func TestSetAuthorityRegistryRejectsBreakingActiveFormula(t *testing.T) {
	...
	_, err := logic.SetAuthorityRegistry(&itick.SetAuthorityRegistryReq{
		Id:           1,
		Authority:    "itick-ws",
		ProviderCode: "ITICK",
		ProducerType: "ITICK_WS",
...
func TestSetAuthorityRegistryAllowsNonBreakingExpansion(t *testing.T) {
	...
	resp, err := logic.SetAuthorityRegistry(&itick.SetAuthorityRegistryReq{
		Id:           2,
		Authority:    "source-ws",
		ProviderCode: "SOURCE",
		ProducerType: "SOURCE_WS",
...
func TestCreateIndexRejectsAuthoritiesFromSameProvider(t *testing.T) {
	...
	_, err := logic.CreatePriceFormula(&itick.CreatePriceFormulaReq{
