...
func (l *SetAuthorityRegistryLogic) SetAuthorityRegistry(in *itick.SetAuthorityRegistryReq) (*itick.AuthorityRegistryResp, error) {
	if in == nil {
	...
	if in.Id == 0 {
		...
		return &itick.AuthorityRegistryResp{Base: helper.OkResp(), Data: data}, nil
	}
