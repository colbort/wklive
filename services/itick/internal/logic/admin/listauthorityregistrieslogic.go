...
func (l *ListAuthorityRegistriesLogic) ListAuthorityRegistries(in *itick.ListAuthorityRegistriesReq) (*itick.ListAuthorityRegistriesResp, error) {
	...
	data := make([]*itick.AuthorityRegistryData, 0, len(rows))
	...
	return &itick.ListAuthorityRegistriesResp{
