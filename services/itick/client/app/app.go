...
type (
	...
	App interface {
		...
		// 订阅数据流
		SubscribeStream(ctx context.Context, in *SubscribeRequest, opts ...grpc.CallOption) (itick.App_SubscribeStreamClient, error)
		// 获取 kline 粒度
...
func (m *defaultApp) ListVisibleCategories(ctx context.Context, in *ListVisibleCategoriesReq, opts ...grpc.CallOption) (*ListVisibleCategoriesResp, error) {
	client := itick.NewAppClient(m.cli.Conn())
...
// 订阅数据流
func (m *defaultApp) SubscribeStream(ctx context.Context, in *SubscribeRequest, opts ...grpc.CallOption) (itick.App_SubscribeStreamClient, error) {
	client := itick.NewAppClient(m.cli.Conn())
