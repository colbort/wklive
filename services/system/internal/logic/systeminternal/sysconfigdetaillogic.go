...
func (l *SysConfigDetailLogic) SysConfigDetail(in *system.SysConfigDetailReq) (*system.SysConfigDetailResp, error) {
	if in == nil {
		return nil, i18n.StatusError(l.ctx, i18n.InvalidQueryCondition)
	}
	...
	if in.Id != nil && *in.Id > 0 {
		...
		config, err = l.svcCtx.ConfigModel.FindOneByTenantIdConfigKey(l.ctx, in.GetTenantId(), sql.NullString{String: in.ConfigKey.String(), Valid: true})
	} else {
