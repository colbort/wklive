...
func (l *Google2FABindLogic) Google2FABind(in *system.Google2FABindReq) (*system.RespBase, error) {
	...
	if err != nil {
		return &system.RespBase{
			Base: helper.ErrResp(i18n.Google2FASecretFetchFailed, i18n.Translate(i18n.Google2FASecretFetchFailed, l.ctx)+": "+err.Error()),
		}, err
	}

	if secret == "" {
		return &system.RespBase{
			Base: helper.ErrResp(i18n.Google2FASecretExpired, i18n.Translate(i18n.Google2FASecretExpired, l.ctx)),
		}, nil
	}
