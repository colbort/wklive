...
type (
	...
	defaultSystemInternal struct {
		cli zrpc.Client
	}
)

func NewSystemInternal(cli zrpc.Client) SystemInternal {
	return &defaultSystemInternal{
		cli: cli,
	}
}

func (m *defaultSystemInternal) SysConfigDetail(ctx context.Context, in *SysConfigDetailReq, opts ...grpc.CallOption) (*SysConfigDetailResp, error) {
	client := system.NewSystemInternalClient(m.cli.Conn())
	return client.SysConfigDetail(ctx, in, opts...)
}

func (m *defaultSystemInternal) SysConfigByKeys(ctx context.Context, in *SysConfigByKeysReq, opts ...grpc.CallOption) (*SysConfigByKeysResp, error) {
	client := system.NewSystemInternalClient(m.cli.Conn())
	return client.SysConfigByKeys(ctx, in, opts...)
}

func (m *defaultSystemInternal) SysTenantList(ctx context.Context, in *SysTenantListReq, opts ...grpc.CallOption) (*SysTenantListResp, error) {
	client := system.NewSystemInternalClient(m.cli.Conn())
	return client.SysTenantList(ctx, in, opts...)
}

func (m *defaultSystemInternal) SysTenantDetail(ctx context.Context, in *SysTenantDetailReq, opts ...grpc.CallOption) (*SysTenantDetailResp, error) {
	client := system.NewSystemInternalClient(m.cli.Conn())
	return client.SysTenantDetail(ctx, in, opts...)
}

func (m *defaultSystemInternal) ResolveTenantDomain(ctx context.Context, in *ResolveTenantDomainReq, opts ...grpc.CallOption) (*ResolveTenantDomainResp, error) {
	client := system.NewSystemInternalClient(m.cli.Conn())
