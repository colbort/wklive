...
CREATE TABLE `t_trade_symbol_spot` (
  ...
  `buy_enabled` TINYINT NOT NULL DEFAULT 1 COMMENT '买入开关：1启用 0禁用',
  `sell_enabled` TINYINT NOT NULL DEFAULT 1 COMMENT '卖出开关：1启用 0禁用',
  `create_times` BIGINT NOT NULL DEFAULT 0 COMMENT '创建时间，毫秒时间戳',
  `update_times` BIGINT NOT NULL DEFAULT 0 COMMENT '更新时间，毫秒时间戳',
  PRIMARY KEY (`id`),
...
CREATE TABLE `t_trade_symbol_contract` (
  ...
  `buy_enabled` TINYINT NOT NULL DEFAULT 1 COMMENT '开多/买入开关：1启用 0禁用',
  `sell_enabled` TINYINT NOT NULL DEFAULT 1 COMMENT '开空/卖出开关：1启用 0禁用',
  `create_times` BIGINT NOT NULL DEFAULT 0 COMMENT '创建时间，毫秒时间戳',
  `update_times` BIGINT NOT NULL DEFAULT 0 COMMENT '更新时间，毫秒时间戳',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_tenant_symbol_id` (`tenant_id`, `symbol_id`)
...
CREATE TABLE `t_trade_user_config` (
  ...
  `trade_enabled` TINYINT NOT NULL DEFAULT 1 COMMENT '交易开关：1启用 0禁用',
  `reduce_only_enabled` TINYINT NOT NULL DEFAULT 0 COMMENT '仅减仓开关：1启用 0禁用',
  `create_times` BIGINT NOT NULL DEFAULT 0 COMMENT '创建时间，毫秒时间戳',
  `update_times` BIGINT NOT NULL DEFAULT 0 COMMENT '更新时间，毫秒时间戳',
  PRIMARY KEY (`id`),
...
CREATE TABLE `t_risk_user_trade_limit` (
  ...
  `trade_enabled` TINYINT NOT NULL DEFAULT 1 COMMENT '交易开关：1启用 0禁用',
  `only_reduce_only` TINYINT NOT NULL DEFAULT 0 COMMENT '仅减仓开关：1启用 0禁用',
