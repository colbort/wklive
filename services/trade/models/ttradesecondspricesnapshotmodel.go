...
func (m *customTTradeSecondsPriceSnapshotModel) FindPage(ctx context.Context, filter AdminPageFilter, cursor, limit int64) ([]*TTradeSecondsPriceSnapshot, int64, error) {
