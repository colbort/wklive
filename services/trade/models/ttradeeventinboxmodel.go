...
func (m *customTTradeEventInboxModel) Claim(ctx context.Context, consumer string, tenantID int64, eventNo, eventType string, now, staleBefore int64) (bool, bool, int64, error) {
...
func (m *customTTradeEventInboxModel) Complete(ctx context.Context, consumer string, tenantID int64, eventNo string, lease, now int64) (bool, error) {
	item, err := m.FindOneByConsumerTenantIdEventNo(ctx, consumer, tenantID, eventNo)
	if err != nil {
		return false, err
	}
...
func (m *customTTradeEventInboxModel) Fail(ctx context.Context, consumer string, tenantID int64, eventNo string, lease int64, errorMessage string, now int64) error {
...
func (m *customTTradeEventInboxModel) conditionalInboxUpdate(ctx context.Context, item *TTradeEventInbox, setClause string, setArgs []any, whereClause string, whereArgs ...any) (bool, error) {
