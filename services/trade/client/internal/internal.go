...
// 记录持仓历史信息
func (m *defaultInternal) RecordPositionHistory(ctx context.Context, in *RecordPositionHistoryReq, opts ...grpc.CallOption) (*InternalCommonResp, error) {
	client := trade.NewInternalClient(m.cli.Conn())
	return client.RecordPositionHistory(ctx, in, opts...)
}

// 创建交易事件
func (m *defaultInternal) CreateTradeEvent(ctx context.Context, in *CreateTradeEventReq, opts ...grpc.CallOption) (*InternalCommonResp, error) {
	client := trade.NewInternalClient(m.cli.Conn())
	return client.CreateTradeEvent(ctx, in, opts...)
}

// 校验订单风控
func (m *defaultInternal) CheckOrderRisk(ctx context.Context, in *CheckOrderRiskReq, opts ...grpc.CallOption) (*CheckOrderRiskResp, error) {
	client := trade.NewInternalClient(m.cli.Conn())
