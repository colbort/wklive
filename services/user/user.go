...
import (
	...
	"wklive/services/user/internal/server"
...
func main() {
	...
	s := zrpc.MustNewServer(c.RpcServerConf, func(grpcServer *grpc.Server) {
		user.RegisterUserAppServer(grpcServer, server.NewUserAppServer(ctx))
		user.RegisterUserAdminServer(grpcServer, server.NewUserAdminServer(ctx))
