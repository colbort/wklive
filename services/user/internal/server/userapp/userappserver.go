...
import (
	...
	"wklive/proto/user"
	"wklive/services/user/internal/logic/userapp"
...
func (s *UserAppServer) CreateGuestTransfer(ctx context.Context, in *user.CreateGuestTransferReq) (*user.CreateGuestTransferResp, error) {
	l := userapplogic.NewCreateGuestTransferLogic(ctx, s.svcCtx)
...
func (s *UserAppServer) ExchangeGuestTransfer(ctx context.Context, in *user.ExchangeGuestTransferReq) (*user.ExchangeGuestTransferResp, error) {
	l := userapplogic.NewExchangeGuestTransferLogic(ctx, s.svcCtx)
...
func (s *UserAppServer) RefreshToken(ctx context.Context, in *user.RefreshTokenReq) (*user.RefreshTokenResp, error) {
	l := userapplogic.NewRefreshTokenLogic(ctx, s.svcCtx)
...
func (s *UserAppServer) GetProfile(ctx context.Context, in *user.GetProfileReq) (*user.GetProfileResp, error) {
	l := userapplogic.NewGetProfileLogic(ctx, s.svcCtx)
...
func (s *UserAppServer) UpdateProfile(ctx context.Context, in *user.UpdateProfileReq) (*user.UpdateProfileResp, error) {
	l := userapplogic.NewUpdateProfileLogic(ctx, s.svcCtx)
...
func (s *UserAppServer) GetIdentity(ctx context.Context, in *user.GetIdentityReq) (*user.GetIdentityResp, error) {
	l := userapplogic.NewGetIdentityLogic(ctx, s.svcCtx)
...
func (s *UserAppServer) SubmitIdentity(ctx context.Context, in *user.SubmitIdentityReq) (*user.SubmitIdentityResp, error) {
	l := userapplogic.NewSubmitIdentityLogic(ctx, s.svcCtx)
...
func (s *UserAppServer) UpdateIdentity(ctx context.Context, in *user.UpdateIdentityReq) (*user.UpdateIdentityResp, error) {
	l := userapplogic.NewUpdateIdentityLogic(ctx, s.svcCtx)
...
func (s *UserAppServer) GetSecurity(ctx context.Context, in *user.GetSecurityReq) (*user.GetSecurityResp, error) {
	l := userapplogic.NewGetSecurityLogic(ctx, s.svcCtx)
...
func (s *UserAppServer) InitGoogle2FA(ctx context.Context, in *user.InitGoogle2FAReq) (*user.InitGoogle2FAResp, error) {
	l := userapplogic.NewInitGoogle2FALogic(ctx, s.svcCtx)
