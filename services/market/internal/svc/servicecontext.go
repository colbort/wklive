...
func NewServiceContext(c config.Config) *ServiceContext {
	...
	marketCategoryModel := models.NewTItickCategoryModel(conn, c.CacheRedis)
	marketProductModel := models.NewTItickProductModel(conn, c.CacheRedis)
	marketTenantCategoryModel := models.NewTItickTenantCategoryModel(conn, c.CacheRedis)
	marketTenantProductModel := models.NewTItickTenantProductModel(conn, c.CacheRedis)
	marketSyncTaskModel := models.NewTItickSyncTaskModel(conn, c.CacheRedis)
	marketQuoteModel := models.NewTItickQuoteModel(conn, c.CacheRedis)
