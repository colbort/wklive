...
type KlineIntervalMeta struct {
	Name   string
	KType  market.KlineType
	Stream string
}

var KlineIntervals = []KlineIntervalMeta{
	{Name: "1m", KType: market.KlineType_KLINE_TYPE_1M, Stream: "kline@1"},
	{Name: "5m", KType: market.KlineType_KLINE_TYPE_5M, Stream: "kline@2"},
	{Name: "15m", KType: market.KlineType_KLINE_TYPE_15M, Stream: "kline@3"},
	{Name: "30m", KType: market.KlineType_KLINE_TYPE_30M, Stream: "kline@4"},
	{Name: "1h", KType: market.KlineType_KLINE_TYPE_60M, Stream: "kline@5"},
	{Name: "1d", KType: market.KlineType_KLINE_TYPE_1D, Stream: "kline@8"},
	{Name: "1w", KType: market.KlineType_KLINE_TYPE_1W, Stream: "kline@9"},
	{Name: "1mo", KType: market.KlineType_KLINE_TYPE_1MO, Stream: "kline@10"},
}
...
var DefaultKTypes = func() []int32 {
	...
	out = append(out, int32(market.KlineType_KLINE_TYPE_1Y))
	return out
}()

var kTypeToName map[market.KlineType]string
var nameToStream map[string]string
var streamToName map[string]string
var nameAliasToName map[string]string

func init() {
	kTypeToName = make(map[market.KlineType]string, len(KlineIntervals))
	...
	kTypeToName[market.KlineType_KLINE_TYPE_1Y] = "1y"
	nameAliasToName["1y"] = "1y"
}

func KlineTypeToInterval(kType market.KlineType) string {
...
func KTypeToIntervalName(kType int32) string {
	return kTypeToName[market.KlineType(kType)]
}
