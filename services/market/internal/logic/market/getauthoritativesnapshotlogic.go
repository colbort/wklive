...
// 按业务时刻读取生产方永久归档的权威快照
func (l *GetAuthoritativeSnapshotLogic) GetAuthoritativeSnapshot(in *market.GetAuthoritativeSnapshotReq) (*market.GetAuthoritativeSnapshotResp, error) {
	if in == nil {
	...
	return &market.GetAuthoritativeSnapshotResp{Base: helper.OkResp(), Data: data}, nil
}

func (l *GetAuthoritativeSnapshotLogic) getAuthoritativeSnapshot(authorityValue, categoryCode, market, symbol string, targetTime, maxLookbackMs int64, snapshotKind string) (*market.AuthoritativeSnapshot, error) {
