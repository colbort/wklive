...
func (l *UpdateTenantProductLogic) UpdateTenantProduct(in *market.UpdateTenantProductReq) (*market.CommonResp, error) {
	...
	if err := l.svcCtx.MarketTenantProductModel.Update(l.ctx, item); err != nil {
		return nil, err
	}
