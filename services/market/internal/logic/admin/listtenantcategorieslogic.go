...
// 租户产品类型列表
func (l *ListTenantCategoriesLogic) ListTenantCategories(in *market.ListTenantCategoriesReq) (*market.ListTenantCategoriesResp, error) {
	items, total, err := l.svcCtx.MarketTenantCategoryModel.FindPage(l.ctx, in.TenantId, in.Page.Cursor, in.Page.Limit)
	if err != nil {
		return nil, err
	}
	...
	return &market.ListTenantCategoriesResp{
