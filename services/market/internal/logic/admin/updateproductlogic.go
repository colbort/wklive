...
func (l *UpdateProductLogic) UpdateProduct(in *market.UpdateProductReq) (*market.CommonResp, error) {
	item, err := l.svcCtx.MarketProductModel.FindOne(l.ctx, in.Id)
	if err != nil {
		return nil, err
	}
	if item == nil {
	...
	if err := l.svcCtx.MarketProductModel.Update(l.ctx, item); err != nil {
		return nil, err
	}
