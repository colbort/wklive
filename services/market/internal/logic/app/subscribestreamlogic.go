...
func (l *SubscribeStreamLogic) SubscribeStream(in *market.SubscribeRequest, stream market.App_SubscribeStreamServer) error {
...
func (l *SubscribeStreamLogic) pushCachedMarketData(
	...
	stream market.App_SubscribeStreamServer,
) error {
	...
	for _, item := range items {
		...
		if err := stream.Send(&market.PushReply{
...
func normalizeUniqueClientMessages(in *market.SubscribeRequest) []types.ClientMessage {
