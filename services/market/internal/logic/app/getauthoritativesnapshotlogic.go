...
// 按业务时刻读取生产方永久归档的权威快照
func (l *GetAuthoritativeSnapshotLogic) GetAuthoritativeSnapshot(in *pb.GetAuthoritativeSnapshotReq) (*pb.GetAuthoritativeSnapshotResp, error) {
	if in == nil {
	...
	return &pb.GetAuthoritativeSnapshotResp{Base: helper.OkResp(), Data: data}, nil
}

func (l *GetAuthoritativeSnapshotLogic) getAuthoritativeSnapshot(authorityValue, categoryCode, market, symbol string, targetTime, maxLookbackMs int64, snapshotKind string) (*pb.AuthoritativeSnapshot, error) {
