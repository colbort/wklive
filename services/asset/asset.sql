...
CREATE TABLE `t_asset_coin_config` (
  ...
  `app_visible` tinyint NOT NULL DEFAULT 1 COMMENT 'APP操作页展示开关:1显示 2隐藏',
  `recharge_enabled` tinyint NOT NULL DEFAULT 2 COMMENT '充值页展示开关:1显示 2隐藏',
  `withdraw_enabled` tinyint NOT NULL DEFAULT 2 COMMENT '提现页展示开关:1显示 2隐藏',
  `transfer_enabled` tinyint NOT NULL DEFAULT 1 COMMENT '划转页展示开关:1显示 2隐藏',
  `enabled` tinyint NOT NULL DEFAULT 1 COMMENT '启用开关:1启用 2禁用',
...
CREATE TABLE `t_asset_insurance_cover` (
  `id` BIGINT NOT NULL AUTO_INCREMENT, `tenant_id` BIGINT NOT NULL, `platform_account_id` BIGINT NOT NULL,
  `coin` VARCHAR(32) NOT NULL, `liquidation_id` BIGINT NOT NULL,
  ...
  KEY `idx_fund_asset_time` (`tenant_id`,`platform_account_id`,`coin`,`create_times`),
