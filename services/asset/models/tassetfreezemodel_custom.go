...
type AssetFreezeModel interface {
	tAssetFreezeModel
	FindPage(ctx context.Context, cursor int64, limit int64) ([]*TAssetFreeze, int64, error)
	FindPageByFilter(ctx context.Context, tenantId int64, userId int64, walletType int64, coin string, bizType string, bizNo string, status int64, cursor int64, limit int64) ([]*TAssetFreeze, int64, error)
	// 解冻时更新冻结记录
...
func (m *defaultTAssetFreezeModel) FindPage(ctx context.Context, cursor int64, limit int64) ([]*TAssetFreeze, int64, error) {
	if limit <= 0 {
		limit = 10
	}
	if limit > 100 {
...
func (m *defaultTAssetFreezeModel) FindPageByFilter(ctx context.Context, tenantId int64, userId int64, walletType int64, coin string, bizType string, bizNo string, status int64, cursor int64, limit int64) ([]*TAssetFreeze, int64, error) {
	if limit <= 0 {
		limit = 10
	}
	if limit > 100 {
