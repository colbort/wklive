...
CREATE TABLE `t_option_contract` (
  ...
  `is_deleted` TINYINT NOT NULL DEFAULT 1 COMMENT '是否删除：1否 2是',
...
CREATE TABLE `t_option_order` (
  ...
  `reduce_only` TINYINT NOT NULL DEFAULT 1 COMMENT '是否只减仓：1否 2是',
  `mmp` TINYINT NOT NULL DEFAULT 1 COMMENT '是否做市商保护单：1否 2是',
...
CREATE TABLE `t_option_settlement` (
  ...
  `is_itm` TINYINT NOT NULL DEFAULT 1 COMMENT '是否实值：1否 2是',
