...
COMPOSE_FILE=${OPTION_BACKSTOP_SCHEMA_COMPOSE_FILE:-$REPO_ROOT/deploy/docker-compose.yml}
...
MYSQL_CONTAINER=${OPTION_BACKSTOP_SCHEMA_MYSQL_CONTAINER:-$(docker compose -f "$COMPOSE_FILE" ps -q mysql)}
