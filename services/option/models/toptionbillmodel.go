...
func (m *customTOptionBillModel) FindPage(ctx context.Context, filter OptionBillPageFilter, cursor int64, limit int64) ([]*TOptionBill, int64, error) {
