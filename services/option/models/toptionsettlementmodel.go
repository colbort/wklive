...
func (m *customTOptionSettlementModel) FindPage(ctx context.Context, filter OptionSettlementPageFilter, cursor int64, limit int64) ([]*TOptionSettlement, int64, error) {
