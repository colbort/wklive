...
func NewOption(cli zrpc.Client) Option {
...
// 同步标的行情，更新对应期权合约行情和快照。
func (m *defaultOption) SyncMarketQuote(ctx context.Context, in *SyncMarketQuoteReq, opts ...grpc.CallOption) (*InternalCommonResp, error) {
	client := option.NewOptionClient(m.cli.Conn())
