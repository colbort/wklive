...
func (l *AppGetOrderDetailLogic) AppGetOrderDetail(in *option.AppGetOrderDetailReq) (*option.AppGetOrderDetailResp, error) {
	...
	if err != nil {
		if errors.Is(err, models.ErrNotFound) {
			return &option.AppGetOrderDetailResp{Base: helper.ErrResp(i18n.OrderNotFound, i18n.Translate(i18n.OrderNotFound, l.ctx))}, nil
		}
		return nil, err
	}
	if item.UserId != userId || item.AccountId != in.AccountId {
		return &option.AppGetOrderDetailResp{Base: helper.ErrResp(i18n.NoPermissionViewOrder, i18n.Translate(i18n.NoPermissionViewOrder, l.ctx))}, nil
	}
