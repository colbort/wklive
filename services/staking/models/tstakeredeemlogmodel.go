...
type (
	StakeRedeemLogPageFilter struct {
		TenantId     int64
		UserId       int64
		OrderId      int64
		ProductId    int64
...
func (m *customTStakeRedeemLogModel) FindPage(ctx context.Context, filter StakeRedeemLogPageFilter, cursor int64, limit int64) ([]*TStakeRedeemLog, int64, error) {
