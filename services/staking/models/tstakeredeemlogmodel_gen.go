...
type (
	...
	TStakeRedeemLog struct {
		...
		StakeAmount  decimal.Decimal `db:"stake_amount"`   // 原始质押数量
		RedeemAmount decimal.Decimal `db:"redeem_amount"`  // 实际赎回本金数量
		RewardAmount decimal.Decimal `db:"reward_amount"`  // 本次一并发放收益数量
