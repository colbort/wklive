...
CREATE TABLE `t_stake_product` (
  ...
  `allow_early_redeem` TINYINT NOT NULL DEFAULT '1' COMMENT '是否允许提前赎回：1否 2是',
...
CREATE TABLE `t_stake_order` (
  ...
  `allow_early_redeem` TINYINT NOT NULL DEFAULT '1' COMMENT '是否允许提前赎回快照：1否 2是',
  ...
  `start_times` INT NOT NULL DEFAULT '0' COMMENT '起息时间戳',
  `end_times` INT NOT NULL DEFAULT '0' COMMENT '到期时间戳，活期可为0',
  `last_reward_times` INT NOT NULL DEFAULT '0' COMMENT '最后一次收益发放时间戳',
  `next_reward_times` INT NOT NULL DEFAULT '0' COMMENT '下一次收益发放时间戳',
  ...
  `redeem_apply_times` INT NOT NULL DEFAULT '0' COMMENT '申请赎回时间戳',
  `redeem_times` INT NOT NULL DEFAULT '0' COMMENT '实际赎回时间戳',
...
CREATE TABLE `t_stake_reward_log` (
  ...
  `reward_status` TINYINT NOT NULL DEFAULT '1' COMMENT '发放状态：1失败 2成功',
  `reward_times` INT NOT NULL DEFAULT '0' COMMENT '收益发放时间戳',
  `remark` VARCHAR(255) NOT NULL DEFAULT '' COMMENT '备注',
  `create_user_id` BIGINT NOT NULL DEFAULT '0' COMMENT '创建人ID',
  `update_user_id` BIGINT NOT NULL DEFAULT '0' COMMENT '更新人ID',
  `create_times` BIGINT NOT NULL DEFAULT '0' COMMENT '创建时间戳',
...
CREATE TABLE `t_stake_redeem_log` (
  ...
  `redeem_times` INT NOT NULL DEFAULT '0' COMMENT '赎回时间戳',
  `remark` VARCHAR(255) NOT NULL DEFAULT '' COMMENT '备注',
  `create_user_id` BIGINT NOT NULL DEFAULT '0' COMMENT '创建人ID',
  `update_user_id` BIGINT NOT NULL DEFAULT '0' COMMENT '更新人ID',
  `create_times` BIGINT NOT NULL DEFAULT '0' COMMENT '创建时间戳',
