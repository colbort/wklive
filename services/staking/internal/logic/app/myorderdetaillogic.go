...
// 获取我的质押订单详情
func (l *MyOrderDetailLogic) MyOrderDetail(in *staking.MyOrderDetailReq) (*staking.MyOrderDetailResp, error) {
	...
	if err != nil {
		if errors.Is(err, models.ErrNotFound) {
			return &staking.MyOrderDetailResp{Base: helper.ErrResp(i18n.OrderNotFound, i18n.Translate(i18n.OrderNotFound, l.ctx))}, nil
		}
		return nil, err
	}
