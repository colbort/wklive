...
// 获取质押产品列表
func (l *ProductListLogic) ProductList(in *staking.UserProductListReq) (*staking.UserProductListResp, error) {
	...
	resp := &staking.UserProductListResp{Base: helper.OkResp()}
	if len(items) == 0 {
