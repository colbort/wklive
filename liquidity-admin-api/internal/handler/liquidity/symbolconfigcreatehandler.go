...
func SymbolConfigCreateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := liquidity.NewSymbolConfigCreateLogic(r.Context(), svcCtx)
		resp, err := l.SymbolConfigCreate(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
