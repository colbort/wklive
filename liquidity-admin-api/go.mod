module wklive/liquidity-admin-api
...
require (
	...
	wklive/services/liquidity v0.0.0-00010101000000-000000000000
	wklive/services/system v0.0.0-00010101000000-000000000000
)
...
replace wklive/services/liquidity => ../services/liquidity

replace wklive/services/system => ../services/system
