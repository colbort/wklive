...
export function apiOptionGetOptions(): Promise<RespBase & { data: OptionsGroup[] }> {
  return http.get('/option/options').then((res: { data: any }) => res.data)
}

export function apiOptionListContracts(
  params: AppListContractsReq,
): Promise<RespBase & { data: OptionContractDetail[] }> {
  return http.get('/option/contracts', { params: compactParams(params) }).then((res: { data: any }) => res.data)
}
...
export function apiOptionPlaceOrder(
  ...
  return http.post('/option/orders', params).then((res: { data: any }) => res.data)
}

export function apiOptionCancelOrder(params: AppCancelOrderReq): Promise<RespBase> {
  return http.post('/option/orders/cancel', params).then((res: { data: any }) => res.data)
}
...
export function apiOptionListTrades(
  ...
  return http.get('/option/trades', { params: compactParams(params) }).then((res: { data: any }) => res.data)
}

export function apiOptionListPositions(
  params: AppListPositionsReq,
): Promise<RespBase & { data: OptionPositionDetail[] }> {
  return http.get('/option/positions', { params: compactParams(params) }).then((res: { data: any }) => res.data)
}
...
export function apiOptionExercise(
  ...
  return http.post('/option/exercise', params).then((res: { data: any }) => res.data)
}

export function apiOptionListExercises(
  params: AppListExercisesReq,
): Promise<RespBase & { data: OptionExerciseDetail[] }> {
  return http.get('/option/exercises', { params: compactParams(params) }).then((res: { data: any }) => res.data)
}

export function apiOptionListAccounts(
  params: AppListAccountsReq,
): Promise<RespBase & { data: OptionAccount[] }> {
  return http.get('/option/accounts', { params: compactParams(params) }).then((res: { data: any }) => res.data)
}

export function apiOptionListBills(
  params: AppListBillsReq,
): Promise<RespBase & { data: OptionBill[] }> {
  return http.get('/option/bills', { params: compactParams(params) }).then((res: { data: any }) => res.data)
}
