...
const apiClientConfig: ApiClientConfig = {
  ...
  apiBasePath: viteEnv.VITE_API_BASE_PATH,
  appTarget: viteEnv.VITE_APP_TARGET,
  tenantCode: viteEnv.VITE_TENANT_CODE,
  tenantId: viteEnv.VITE_TENANT_ID,
}
...
export function getApiBaseUrl() {
  return apiClientConfig.apiBaseUrl?.trim() || ''
}
...
function resolveApiBaseURL() {
  ...
  const target = apiClientConfig.appTarget
...
export function getTenantId() {
  return localStorage.getItem(TENANT_ID_KEY) || apiClientConfig.tenantId || ''
}
