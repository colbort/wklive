...
func (l *HandleChatWorkOrderLogic) HandleChatWorkOrder(req *types.HandleChatWorkOrderReq) (resp *types.ChatWorkOrderResp, err error) {
	return logicutil.Proxy[types.ChatWorkOrderResp](l.ctx, req, l.svcCtx.ChatAdminCli.HandleChatWorkOrder)
}
