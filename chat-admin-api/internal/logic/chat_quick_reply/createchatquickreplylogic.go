...
func (l *CreateChatQuickReplyLogic) CreateChatQuickReply(req *types.CreateChatQuickReplyReq) (resp *types.ChatQuickReplyResp, err error) {
	return logicutil.Proxy[types.ChatQuickReplyResp](l.ctx, req, l.svcCtx.ChatAdminCli.CreateChatQuickReply)
}
